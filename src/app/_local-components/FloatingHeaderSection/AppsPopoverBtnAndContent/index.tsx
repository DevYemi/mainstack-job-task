...
import {
  ...
  MediaKitIcon,
  StoreIcon,
} from "@/global-components/custom-icons";
  ...
  return (
    ...
    >
      <PopoverTrigger>
        ...
        >
          <chakra.div display={"flex"} alignItems={"center"} gap={"0.8rem"}>
            <Icon w={"2rem"} h={"2rem"} as={TbApps} />
            <chakra.p layerStyle={"base-text"}>Apps</chakra.p>
          </chakra.div>
          <chakra.div
            ...
            gap={"0.8rem"}
          >
            <chakra.p layerStyle={"base-text"}>Link In Bio</chakra.p>
