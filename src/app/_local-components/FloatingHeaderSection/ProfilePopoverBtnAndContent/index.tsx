    ...
    <Popover placement="bottom-start" gutter={20}>
      <PopoverTrigger>
        <chakra.button
          ...
          borderRadius={"10rem"}
        >
          <SkeletonCircle w={"3.2rem"} h={"3.2rem"} isLoaded={!isLoading}>
            <Avatar
              w={"3.2rem"}
              h={"3.2rem"}
              color={"white"}
      ...
      <PopoverContent borderRadius={"1.6rem"} shadow={"md"} w={"40rem"}>
        ...
        >
          <chakra.div
            ...
            color={"gray.400"}
          >
            <SkeletonCircle w={"4.8rem"} h={"4.8rem"} isLoaded={!isLoading}>
              <Avatar
                w={"4.8rem"}
                h={"4.8rem"}
                color={"white"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Settings</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Purchase History</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Refer And Earn</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Integration</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Report Bug</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Switch Account</chakra.p>
          </chakra.button>
          <chakra.button
            display={"flex"}
            alignItems={"center"}
          ...
          >
            ...
            <chakra.p layerStyle={"base-text"}>Sign Out</chakra.p>
          </chakra.button>
        </PopoverBody>
      </PopoverContent>
    </Popover>
